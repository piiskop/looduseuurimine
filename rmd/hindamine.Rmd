...
See tähendab, et kui protokollidega on kõik korras, siis kontrolltööde tulemused moodustavad kursuse lõpphindest \qty{100}{\percent}, ja kui protokollidega ei ole kõik korras, siis kontrolltööde tulemused moodustavad kursuse lõpphindest \qty{0}{\percent}.

Eristavalt hinnatavat sooritust tohib õpilane sooritama asuda, kui on kõik oma kaasasolevad nutiseadmed asetanud minu näidatud kohta. Testimise kestel on õpilasel lubatud kasutada õpetaja arvutit üksnes tõlkimiseks ja / või arvutamiseks, nii et korraga teeb seda üks õpilane ja mitte kauem kui pool minutit. Igasugune muu nutiseadme puudutamine lähiajaloo teadmiste-oskuste testimise kestel klassifitseerub mittelubatud kõrvalise abi kasutamiseks või mahakirjutamiseks. Lubatud on kasutada iseenda loodud konspekti.
...
Kui õpilane selgitab tahvli abil uut teemat õppides kõigile korrektselt mingi analüütikaülesande, saab ta selle kohta ühe protsendipunkti kursuse lõpphindest juurde. Kui vajab abi, aga lahendab ära, saab pool protsendipunkti. Tagan, et kõik soovijad saaksid võrdselt selgitada, mis tähendab, et kui keegi juba selgitas, aga soovijaid on veel, siis tuleb võtta järgmisena muu soovija, kes veel pole selgitanud. Esimesena saab selgitama esimesena soovi avaldanud õpilane. Mitteeristava hindega kursuses või kursuse osas tähendab üks protsendipunkt, et ühte sama mooduli praktilist asja tegema ei pea.
...
Kui õpilasel on iseseisvaks lahendamiseks jäetud ülesanne lahendamata, peab ta seda tüüpi ülesande lahendama kursuse lõpus kontrolltöös. Tahvlile lahendab ülesande sellises juhus muu õpilane samadel tingimustel, kui selline õpilane on.

Iseseisvaks lahendamiseks jäetud ülesannete lahendused tuleb mulle esitada eraldi paberil või virtuaalsel tahvlil mulle identifitseeritavana, kelle lahendusega on tegemist, ja kuupäevaga ülesande lahendamise tähtajale järgneva õppesessioonini. Tagasisidestan hiljemalt omakorda järgmise õppesessioonide päeva kestel, misjärel õpilane lisab kommentaarid oma soorituse kohta ja hinde, lahendab oma vihikusse ka ning tagastab mulle hiljemalt omakorda järgmise õppesessioonide päeva õppesessioonis.

Kui õpilane näitab oma lahenduskäigu tahvli abil kõigile, on hinde kaal \num{0,6}, muidu \num{0,4}. Igat ülesannet saab tahvli abil selgitada ainult üks õpilane, välja arvatud juhul, kui teine lahenduskäik erineb esimesest.

#### Lähiajalugu

Kui iseseisvaks lahendamiseks pole vastavaks kontaktsessioonide päevaks jäetud mitte ühtki ülesannet, toimub esimese 30 minuti kestel kontroll teadmiste-oskuste kohta infos, mis on saadud alates eelmise sellise kontrolli järgsest hetkest kuni eelneva kontaktsessioonide päeva lõpuni. Selles kontrollis osalevad kõik kohalolevad õpilased. Arutleda tuleb võimalikult põhjalikult, kuid püsides teemas. Väliseid allikaid kasutada ei ole lubatud.
...
Lähiajaloo test koosneb kolmest ülesandest, millest igaüht hinnatakse eraldi. Igat hinnet on võimalik parandada kursuse lõpus toimuvas kontrolltöös.

Lähiajaloo hinnete kaal on \num{0,6}.
...
Igaks järgnevaks õppesessioonide päevaks koostab õpilane aktuaalse õppesessioonide päeva temaatika kohta ülesande, mis võib olla ka küsimus. See ülesanne peab olema esitatud koos tervikliku lahenduskäiguga. Hindan ülesande kvaliteeti. Kui ülesanne on kvaliteetne, siis ma kaasan ülesande kontrolltöösse. Kui ülesanne on ebakvaliteetne, annan õpilasele võimaluse ülesanne kvaliteetseks teha.
