...
include_external_graphics("rmd/physics-uncertainty.svg")                                # 2
                                                                                 # 3
```
...
include_external_graphics("rmd/skaaladega-joonlaud.png")                                # 2
                                                                                 # 3
```
...
ggplot(data = ruler_data_frame, mapping = aes(x = `ruler_x_actual`, y = 0)) +                                                                                                                                                                                                   # 13
  ...
  theme(axis.title.x = element_text(colour = color_x), axis.text.x = element_text(colour = color_x), axis.ticks.x = element_line(colour = color_x), axis.title.y=element_blank(), 
...
include_external_graphics("rmd/nihik.jpg")                                # 2
                                                                                 # 3
```
...
include_external_graphics("rmd/light-meter.jpg")                                # 2
                                                                                 # 3
```
...
color_x <- "#008000"                                                                                                                                                                                                                                                                             # 10
                                                                                                                                                                                                                                                                                                 # 12
ggplot(data = illuminance_data_frame, mapping = aes(x = `illuminance`, y = 0)) +                                                                                                                                                                                                   # 13
  geom_point(shape = 23, size = 1) +    
  geom_point(aes(x = illuminance_mean, y = 0), shape = 23, size = 2, color = color_x) +
  labs(x = TeX("$\\frac{\\textit{q}}{lx}$")) +                                                                                                                                                          # 15
